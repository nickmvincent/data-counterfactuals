...
The common template below is deliberately lossy. Some tasks fit it neatly; others only fit after some coercion. That is already useful to know.
...
That is why I still find the umbrella useful. The shared object is not a single formula, and not a claim of formal reducibility. The shared object is a comparison between training worlds, plus a recurring question about what sort of intervention, observer, or institution is allowed to make that comparison matter.

## What I would add next

This draft still leaves out several contexts that also fit naturally:
